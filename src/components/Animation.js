...
const Animation = () => {
  ...
  const handleNextClick = () => {
    setSelectedImageIndex((selectedImageIndex + 1) % Images[0].list.length);
  };

  const handlePrevClick = () => {
    setSelectedImageIndex(
      (selectedImageIndex - 1 + Images[0].list.length) % Images[0].list.length
    );
  };
  ...
  return (
    <div className="animation-div" id="Gallery">
      <h2 className="hr-lines" style={{ color: "darkgray" }}>
        Animation
      </h2>
      <Container>
